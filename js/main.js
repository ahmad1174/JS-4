...
const people = ['Beck, Glenn', 'Becker, Carl', 'Beckett, Samuel', 'Beddoes, Mick',
    ...
    'Luciano', 'Berle, Milton', 'Berlin, Irving', 'Berne, Eric', 'Bernhard, Sandra',
...
// const indYears=inventors.map(inventor => `${inventor.first}`+" "+`${inventor.last}`+" "+(inventor.passed-inventor.year));
// console.log(indYears.sort());
// Array.prototype.sort()
// 3. Sort the inventors by birthdate, oldest to youngest
// const age=inventors.sort((a,b)=> a.year>b.year ? 1 : -1).reverse();
// console.table(age);
...
// const old= inventors.sort(function(a,b)
// {const lg=a.passed-a.year;
// const  ng=b.passed-b.year;
// return lg>ng?1:-1});
// console.table(old.reverse());
...
//     return al>al?1:-1;
// });
// console.table(lastname.reverse());
// 8. Reduce Exercise
// Sum up the instances of each of these

const data = ['car', 'car', 'truck', 'truck', 'bike', 'walk', 'car', 'van', 'bike', 'walk', 'car', 'van', 'car', 'truck' ];
const sumInst=data.reduce((o,inst)=>
{if(!o[inst]){
o[inst]=0;
    }
    o[inst]++;
    return  o;},{});
console.table(sumInst);
